...
One branch per experiment family (`scav/research/e{NNN}-{slug}`), with orthogonal variants isolated by config flags, not branches. See **`docs/EXPERIMENT-WORKFLOW.md`** for the full lifecycle.
