...
- **Bo1 matches**: Likely completes successfully
- **Most matches**: Will finish without desync
- **SmashBot vs SmashBot**: Tested successfully with delay=6
...
- **Complex characters**: Marth less stable than Fox

### What Doesn't Work ❌

- **delay=2** (default): Freezes in seconds with active AI
- **Without postgame fix**: Freezes mid-explosion
- **Random fighter**: Less stable than SmashBot (more chaotic inputs)

## Known Issues

1. **Desyncs still occur** - delay=6 reduces but doesn't eliminate them
